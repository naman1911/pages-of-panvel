...
export const DEMO_PUBLIC = {
  members: {
    ...
    "u-vineet":   { name: "Vineet",    joined: d(84), days: run(23) },
    "u-ronit": { name: "Ronit",  joined: d(70), days: run(6) },
    "u-rishikesh":   { name: "Rishikesh",    joined: d(65), days: run(14) },
    "u-vaishnavi":    { name: "Vaishnavi",     joined: d(60), days: run(4, 2) },
    "u-anushka":    { name: "Anushka",     joined: d(45), days: run(9) },
    "u-siddhi":   { name: "Siddhi", joined: d(30), days: run(2) },
    "u-yugandhar":     { name: "Yugandhar",   joined: d(21), days: run(17) },
  },
  books: [
    ...
    { id: "b2", uid: "u-vineet", title: "The Enchantress of Florence", author: "Salman Rushdie",
      genre: "Fiction", lang: "English", status: "reading", startedAt: d(3), line: "", lendable: true },
    { id: "b3", uid: "u-ronit", title: "कोसला", author: "भालचंद्र नेमाडे",
      genre: "Fiction", lang: "मराठी", status: "reading", startedAt: d(9), line: "", lendable: false },
    { id: "b4", uid: "u-rishikesh", title: "Annihilation", author: "Jeff VanderMeer",
    ...
    { id: "b6", uid: "u-vaishnavi", title: "गुनाहों का देवता", author: "धर्मवीर भारती",
      genre: "Fiction", lang: "हिंदी", status: "reading", startedAt: d(4), line: "", lendable: false },
    { id: "b7", uid: "u-anushka", title: "The Sea Around Us", author: "Rachel Carson",
    ...
    { id: "b15", uid: "u-anushka", title: "Midnight's Children", author: "Salman Rushdie",
      genre: "Fiction", lang: "English", status: "finished", startedAt: d(50),
      finishedAt: d(20), line: "", lendable: false },
    { id: "b16", uid: "u-yugandhar", title: "The Tale of Genji", author: "Murasaki Shikibu",
      genre: "Fiction", lang: "English", status: "reading", startedAt: d(16), line: "", lendable: false },
    { id: "b17", uid: "u-siddhi", title: "Silent Spring", author: "Rachel Carson",
      genre: "Science", lang: "English", status: "finished", startedAt: d(28),
      finishedAt: d(9), line: "", lendable: true },
    { id: "b18", uid: "u-vaishnavi", title: "Persepolis", author: "Marjane Satrapi",
      genre: "Graphic novel", lang: "English", status: "reading", startedAt: d(5), line: "", lendable: false },
  ],
  board: [
    { id: "p1", uid: "u-anushka", text: "Want to read out the bit about the deep sea. Two minutes, I promise.", at: d(2) },
    { id: "p2", uid: "u-ronit", text: "Does anyone else find Kosla unbearable and brilliant at the same time?", at: d(3) },
    { id: "p3", uid: "u-yugandhar", text: "Bringing the Kolatkar. Someone please take it off me for a month.", at: d(4) },
  ],
};
